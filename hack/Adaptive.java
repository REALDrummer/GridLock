...
public class Adaptive{
	...
	public Intersection.TrafficFlow randomFlow(){
		...
		switch(rand){
			case 0: return Intersection.TrafficFlow.NORTH_SOUTH;
			case 1: return Intersection.TrafficFlow.EAST_WEST;
			case 2: return Intersection.TrafficFlow.NORTH_SOUTH_LEFT;
			case 3: return Intersection.TrafficFlow.EAST_WEST_LEFT;
			default:
